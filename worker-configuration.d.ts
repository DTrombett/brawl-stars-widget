/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dad69242219ec5359016f0e58a215e5b)
// Runtime types generated with workerd@1.20260706.1 2026-07-07 
interface __BaseEnv_Env {
	...
	NODE_ENV: string;
	DOMAIN: string;
	BRAWL_API_BASE: string;
	BRAWL_STARS_API_TOKEN: string;
	UPDATE_WIDGET: Workflow<Parameters<import("./src/index").UpdateWidget['run']>[0]['payload']>;
}
